---
title: "Historical Legacies of Redlining in LA County"
...
# redlining data 
holc_redlining <- st_read(here("data/mapping-inequality/mapping-inequality-los-angeles.json"))
...
la_county <- st_read(here("data/la_county_boundary/County_Boundary.shp")) %>% 
  st_transform(crs = st_crs(holc_redlining)) # set same CRS as redlining data
la_county <- la_county %>%
